...
class MyVersion_HandGestureDetectorUsingAngle_support2hands:
    ...
    def hand1GestureJudge():
        ...
        cv2.putText(image, hand1_label + hand1GestureJudgeResult, (int(cam_width / 3 - 60), 60),
    ...
    def hand2GestureJudge():
        ...
        cv2.putText(image, hand2_label + hand2GestureJudgeResult, (int(cam_width / 3 - 60), 120),
                    cv2.FONT_HERSHEY_COMPLEX,
                    1.5, (0, 255, 0), 2)
            ...
            if results.multi_hand_landmarks:
                ...
                for idx, landmark in enumerate(results.multi_hand_landmarks[0].landmark):
                    if landmark.visibility < 0 or landmark.presence < 0:
                        continue
                    landmark_px = normalized_3_pixel_coordinates(landmark.x, landmark.y, landmark.z, image_cols,
                                                                 image_rows)
                    if landmark_px:
